var main = new function () {
  ...
  this.togglePythonMenu = function (e) {
    if ($('.pythonMenuDropDown').length == 0) {
      ...
      let menuItems = [
        { html: 'Ext Robotics Mode', line: true, callback: self.switchToExtRobotics },
      ...
      var tickIndex;
      if (blockly.generator == ext_robotics_generator) {
        tickIndex = 0;
      }
  ...
  // switch to ext_robotics
  this.switchToExtRobotics = function () {
    blockly.generator = ext_robotics_generator;
    blockly.generator.load();
    blockly.loadExtRoboticsToolbox();
